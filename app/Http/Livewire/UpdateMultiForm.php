...
class UpdateMultiForm extends Component
{
    ...
    public function update()
    {
        ...
        if($this->address_link != NULL || $this->address_link != '-'){
        ...
        if($this->Harga_sewa_pertahun != NULL || $this->Harga_sewa_pertahun != '-'){
            $this->Harga_sewa_pertahun = number_format($this->Harga_sewa_pertahun, 0, '', '.');
        }
        
        if($this->Harga_sewa_per6bulan != NULL || $this->Harga_sewa_per6bulan != '-'){
            $this->Harga_sewa_per6bulan = number_format($this->Harga_sewa_per6bulan, 0, '', '.');
        }
        
        if($this->Harga_sewa_per3bulan != NULL || $this->Harga_sewa_per3bulan != '-'){
            $this->Harga_sewa_per3bulan = number_format($this->Harga_sewa_per3bulan, 0, '', '.');
        }
        
        if($this->Harga_sewa_perbulan != NULL || $this->Harga_sewa_perbulan != '-'){
            $this->Harga_sewa_perbulan = number_format($this->Harga_sewa_perbulan, 0, '', '.');
        }
